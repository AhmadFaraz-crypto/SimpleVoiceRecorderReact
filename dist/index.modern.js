...
var useRecorder = function useRecorder() {
  ...
  var clearRecording = useCallback(function () {
  ...
  var pauseRecording = useCallback(function () {
  ...
  var resumeRecording = useCallback(function () {
    if (!recorderRef.current) {
      console.warn('No recorder instance available');
      return;
    }
...
var Recorder = function Recorder(_ref) {
  ...
  return React.createElement("div", {
  ...
  }, !hideAudioTitle && React.createElement("h3", {
    className: safeStyles.title
  }, title || 'Audio Recorder'), error && React.createElement("div", {
    ...
    "aria-live": "polite",
    "aria-atomic": "true"
  }, formatTime(hours, minutes, seconds)), React.createElement("div", {
    className: safeStyles.recordingBtn
  }, !isRecording && !audioURL && React.createElement("button", {
    type: "button",
    ...
    tabIndex: 0
  }, "Start Recording"), isRecording && React.createElement(React.Fragment, null, React.createElement("button", {
    type: "button",
    ...
    tabIndex: 0
  }, "Stop Recording"), showPauseButton && React.createElement("button", {
    type: "button",
    ...
    tabIndex: 0
  }, isPaused ? 'Resume Recording' : 'Pause Recording')), audioURL && React.createElement(React.Fragment, null, showAudioPlayUI && React.createElement("div", {
  ...
  }, "Your browser does not support the audio element.")), React.createElement("div", {
    className: safeStyles.actions
  }, showDownloadButton && React.createElement("button", {
    type: "button",
    ...
    tabIndex: 0
  }, "Download"), showClearButton && React.createElement("button", {
    type: "button",
